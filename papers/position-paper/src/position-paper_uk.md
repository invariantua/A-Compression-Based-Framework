...
> Незалежний дослідник, Київ, (Україна Independent Researcher, Kyiv, Ukraine)
...
# **Поле відмінностей, інваріантність і суб'єктивність: концептуальна нотатка**
(Difference Fields, Emergent Invariants, and the Subjectivity: A Conceptual Note)
...
Щоб зробити цю проблему максимально наочною, у статті розглядається граничний уявний експеримент, у якому суб’єкт (S) поміщений у майже однорідне середовище, в якому фізично присутня велика кількість даних, але майже відсутні доступні зовнішні інваріанти (I). Уявний характер цього прикладу частково натхненний перцептивною ситуацією, близькою до тієї, яку створює інсталяція Antony Gormley *Blind Light* (2007). Мета цього експерименту не в тому, щоб емпірично довести нову теорію, а в тому, щоб виявити межу інтуїції, за якою світ автоматично мислиться як уже структурований.
...
2. **внутрішні інваріантні структури** — ті, що пов’язані з самим суб’єктом (S) і підтримують його мінімальну цілісність.
...
Кожен новий рівень характеризується меншою потужністю опису, але більшою стійкістю і більшою здатністю до інтеграції. Те, що на нижчому рівні виглядає як величезна кількість відмінностей, на вищому рівні може бути згорнуте в невелику кількість інваріантних структур (\mathcal{I}).

Таким чином, кожне згортання одночасно:

* зменшує кількість доступних відмінностей;
* підвищує стійкість інваріантних структур (\mathcal{I});
...
## **VIII. Суб'єкт як узгоджена інваріантна структура**

У межах запропонованої рамки суб’єкт (S) не може бути розглянутий як щось первинне і самодостатнє. Якщо світ виникає лише там, де з поля (D) виділяються та узгоджуються інваріантні структури (\mathcal{I}), то саме (S) також повинен бути результатом такого процесу.

Це означає, що (S) не передує інваріантним структурам (\mathcal{I}), а виникає разом із ними. Водночас (S) не є просто однією з інваріантних структур серед інших. Він є особливим випадком — такою інваріантною структурою (I), яка здатна інтегрувати інші інваріантні структури (\mathcal{I}) в узгоджений доступний світ і водночас підтримувати власну цілісність.

У цьому сенсі (S) можна визначити так:

> (S) — це інваріантна структура вищого порядку (I), яка інтегрує доступні інваріантні структури (\mathcal{I}) в узгоджений світ, зберігаючи при цьому власну безперервність.
...
Разом з тим людські суб’єкти (S) зазвичай сприймають світ подібно. У межах цієї статті це можна пояснити тим, що людські (S) виникають на основі близьких або частково перекривних послідовностей згортань. Вони мають подібні тіла, подібні внутрішні ритми, подібні сенсорні обмеження, і тому доступні їм інваріантні структури (\mathcal{I}) значною мірою збігаються. Саме завдяки цьому люди можуть говорити про “один і той самий” світ, хоча жоден суб’єкт (S) не має до нього повного доступу.

Особливо важливо, що (S) не лише інтегрує світ, а й постійно підтримує власну безперервність. Щоб залишатися собою, суб’єкт (S) змушений згортати безліч відмінностей у відносно стійку форму. Якщо ця форма руйнується, руйнується й можливість бачити світ як узгоджену цілісність.

У кімнаті з однорідним туманом це проявляється особливо ясно. Коли майже всі зовнішні інваріантні структури (\mathcal{I}) стають недоступними, суб’єкт (S) не перестає існувати повністю. Він продовжує утримувати мінімальну форму самості через внутрішні інваріантні структури (\mathcal{I}) — серцебиття, дихання, тілесне відчуття. Саме вони підтримують найпростішу безперервність (S), навіть тоді, коли зовнішній світ майже зникає.

Водночас цей thought experiment не слід розуміти як нейтральний або нескінченно стабільний стан. Історичні експерименти із сенсорною та перцептивною депривацією показують, що тривала втрата доступних зовнішніх інваріантних структур (\mathcal{I}) має руйнівний вплив на узгоджений суб’єкт (S). У дослідженнях, проведених у 1950-х роках під керівництвом Donald O. Hebb в McGill University, добровольці перебували в умовах майже повної сенсорної ізоляції: у невеликих кімнатах, із закритими очима, приглушеним звуком і мінімальним тактильним контактом. Уже через кілька годин у багатьох учасників виникали труднощі з послідовним мисленням, а приблизно через дві доби більшість повідомляла про галюцинації, втрату відчуття реальності та розпад звичних когнітивних структур. Через сильний психологічний вплив експерименти часто доводилося припиняти раніше запланованого часу; майже ніхто з учасників не міг витримати більше кількох діб.

У межах запропонованої рамки це можна інтерпретувати як наслідок того, що внутрішніх інваріантних структур (\mathcal{I}) виявляється недостатньо для довготривалого підтримання узгодженого суб’єкта (S). Коли зовнішні інваріантні структури (\mathcal{I}) зникають, (S) ще певний час зберігає себе через серцебиття, дихання і тілесну безперервність. Але якщо нові зовнішні інваріантні структури (\mathcal{I}) не з’являються, процес згортання починає втрачати стійкість. Узгоджений світ руйнується, а разом із ним починає руйнуватися і сам суб’єкт (S) як структура, здатна інтегрувати досвід у цілісність.
...
Це дозволяє припустити, що (S) виникає не внаслідок одиничного акту, а як результат багаторівневого згортання, у якому дедалі складніші інваріантні структури (\mathcal{I}) інтегруються в більш стійку цілісність. На нижчих рівнях можуть існувати лише окремі інваріантні структури (I). На вищих рівнях з’являється можливість не лише утримувати ці структури, а й співвідносити їх між собою і зберігати безперервність самого процесу співвіднесення. Саме така структура і є суб’єктом (S).
...
> Суб’єкт (S) не пізнає поле (D) повністю. Він існує лише як локальний, частковий і самопідтримуваний режим доступності (D).

---

## **IX. Межі гіпотези і відкриті питання**

Запропонована в цій статті рамка не є завершеною фізичною, математичною або кібернетичною теорією. Вона не претендує на те, щоб безпосередньо замінити сучасні уявлення про простір, час, інформацію або свідомість. Її мета значно скромніша: запропонувати концептуальну мову, яка дозволяє спільно розглядати поле відмінностей (D), інваріантні структури (\mathcal{I}), багаторівневе згортання і суб’єкта (S).

Саме тому більшість уведених понять мають попередній статус. Поле (D), оператор згортання (C), інваріантна структура (I), доступний світ і сам суб’єкт (S) поки що слід розглядати не як строго формалізовані об’єкти, а як робочі поняття, призначені для подальшого уточнення.

Найважливішим відкритим питанням залишається природа самого згортання. У статті воно описувалося лише концептуально як перехід від більшої кількості відмінностей до меншої кількості інваріантних структур (\mathcal{I}). Проте поки не зрозуміло:

* які саме критерії визначають можливість згортання;
* які структури можуть вважатися інваріантними;
* чому одні послідовності згортань приводять до появи суб’єкта (S), а інші — ні;
...
Також залишається відкритим питання про межі застосування цієї рамки. Можливо, вона придатна лише для опису певного класу суб’єктів (S), наприклад людського. Можливо, різні типи суб’єкта (S) можуть мати настільки відмінні інваріантні структури (\mathcal{I}), що поняття простору, часу і навіть об’єкта набуватимуть для них зовсім іншого змісту. У такому випадку людський світ виявиться лише одним із багатьох можливих способів організації поля (D).

Особливу увагу слід приділити й самому поняттю суб’єкта (S). У статті він був описаний як інваріантна структура вищого порядку (I), яка підтримує власну безперервність. Проте навіть це визначення залишається неповним. Потрібно окремо з’ясувати:

* за яких умов множина інваріантних структур (\mathcal{I}) може стати узгодженим суб’єктом (S);
* чи існує мінімальний рівень складності, необхідний для появи самості;
* чи можна описати суб’єкта (S) без використання вже готових понять часу і пам’яті.
...
> Запропонована рамка є не відповіддю, а запрошенням до критичної дискусії про те, чи можуть простір, час, світ і сам суб’єкт (S) бути не первинними сутностями, а результатом багаторівневого згортання поля відмінностей (D).
...
у межах якої кожен новий рівень зменшує кількість доступних відмінностей, але підвищує стійкість і інтегрованість інваріантних структур (\mathcal{I}). У цій перспективі суб’єкт (S) не є первинною сутністю, а постає як інваріантна структура вищого порядку (I), яка здатна інтегрувати доступні інваріантні структури (\mathcal{I}) в узгоджений світ і підтримувати власну безперервність.
...
є множиною інваріантних структур рівня (n). Тоді суб’єкт (S) можна розглядати як результат інтеграції таких структур:

[
S = F(\mathcal{I}_0,\mathcal{I}_1,\dots,\mathcal{I}_n)
]

де (F) позначає процес узгодження, який підтримує цілісність і безперервність суб’єкта (S).

Запропонована рамка не претендує на завершену теорію. Її завдання полягає в тому, щоб запропонувати мінімальну мову для обговорення зв’язку між полем відмінностей (D), інваріантністю, простором, часом і самістю. У цьому сенсі статтю слід розглядати як першу постановку питання і як запрошення до подальшої формальної та міждисциплінарної дискусії.
